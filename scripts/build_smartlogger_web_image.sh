...
PROJECT_DIR="/var/www/web_smartlogger"
IMAGE_NAME="smartlogger-react"
...
if [ $? -eq 0 ]; then
  log_output "Construir imagem do smartlogger-react" "success"
else
  log_output "Construir imagem do smartlogger-react" "error"
  exit 1
fi
